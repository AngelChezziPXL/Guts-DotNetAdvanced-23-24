...
namespace HealthHub.Infrastructure
{
    internal class AppointmentsRepository: IAppointmentsRepository
    {
        ...
        public IEnumerable<Appointment> GetAppointmentsForPatient(string patientNationalNumber)
        {
            throw new NotImplementedException();
        }

        public IEnumerable<Appointment> GetUpcomingAppointments(int daysAhead)
        {
            throw new NotImplementedException();
        }
    }
