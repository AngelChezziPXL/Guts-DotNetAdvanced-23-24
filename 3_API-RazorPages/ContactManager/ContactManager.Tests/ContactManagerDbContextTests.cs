...
namespace ContactManager.Tests
{
    ...
    internal class ContactManagerDbContextTests : DatabaseTests
    {
        ...
        [MonitoredTest("ContactManagerContext - OnModelCreating - should seed the Companies and Contacts")]
        ...
        [MonitoredTest("ContactManagerContext - There must be a relation between Companies and Contacts")]
