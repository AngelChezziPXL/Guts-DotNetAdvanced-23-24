...
namespace ContactManager.Tests
{
    ...
    public class AddContactPageModelTests
    {
        ...
        [MonitoredTest("AddContactModel - Contact property should have a BindProperty attribute")]
        ...
        [MonitoredTest("AddContactModel - Constructor - Should initialize a list of company SelectListItems")]
        ...
        [MonitoredTest("AddContactModel - Constructor- Should initialize an empty contact")]
        ...
        [MonitoredTest("AddContactModel - OnGet - Should do nothing")]
        ...
        [MonitoredTest("AddContactModel - OnPost - Valid model state - Should add contact and redirect to Index page")]
        ...
        [MonitoredTest("AddContactModel - OnPost - Invalid model state - Should stay on page")]
        public void _06_OnPost_InValidModelState_ShouldStayOnPage()
        {
            //Arrange
            var model = new AddContactModel(_companyRepositoryMock.Object, _contactRepositoryMock.Object);
            model.ModelState.AddModelError("someError", "The Contact property is not valid");
