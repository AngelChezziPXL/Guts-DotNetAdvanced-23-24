...
{
    [ExerciseTestFixture("dotnet2", "7-NUnit", "RomanNumberConverter",
    ...
    public class RomanNumberConverterTestsTests
    {
        ...
        [MonitoredTest("Should have a test that checks if the value is in range")]
        ...
        [MonitoredTest("The test that checks if the value is in range should pass")]
        ...
        [MonitoredTest("The test that checks if the value is in range should pass for correct expectations")]
        ...
        [MonitoredTest("The test that checks if the value is in range should fail for wrong expectations")]
        ...
        [MonitoredTest("Should have a test that checks conversion of valid numbers")]
        ...
        [MonitoredTest("The test that checks conversion of valid numbers should pass")]
        ...
        [MonitoredTest("The test that checks conversion of valid numbers should pass for correct expectations")]
        ...
        [MonitoredTest("The test that checks conversion of valid numbers should fail for wrong expectations")]
